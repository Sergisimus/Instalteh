        ...
        <form className='contact_form'>
          <div className='first_row'>
            <div className='first_row_item'>
              ...
              <input className='contact_name_input contact_input' name='name' type='text' placeholder='Your Name'></input>
            </div>
            <div className='first_row_item'> 
              <label className='contact_email contact_item'>EMAIL</label> 
              <input className='contact_email_input contact_input' name='email' type='email' placeholder='Your Email'></input>
            </div>           
          </div>          
